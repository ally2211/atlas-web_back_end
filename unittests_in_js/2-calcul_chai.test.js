...
const { describe, it } = require('mocha'); // CommonJS for Mocha

async function runTests() {
    const { expect } = await import('chai'); // Use dynamic import for Chai
    const calculateNumber = (await import('./2-calcul_chai.js')).default; // Dynamic import for your function
